  ...
  const metrics = [
    {
      ...
      badgeColor: isProfitable ? 'bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border-emerald-500/20' : 'bg-rose-500/10 text-rose-600 dark:text-rose-400 border-rose-500/20',
      icon: TrendingUp,
      accent: isProfitable ? 'from-emerald-400 to-teal-500' : 'from-rose-400 to-red-500',
      valueColor: isProfitable ? 'text-emerald-600 dark:text-emerald-400' : 'text-rose-600 dark:text-rose-400',
    },
    {
      title: 'Win Ratio',
      value: `${summary.win_rate_pct.toFixed(1)}%`,
      badge: `${summary.winning_trades}W / ${summary.losing_trades}L`,
      badgeColor: summary.win_rate_pct >= 50 ? 'bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border-emerald-500/20' : 'bg-amber-500/10 text-amber-600 dark:text-amber-400 border-amber-500/20',
      icon: Award,
      accent: 'from-amber-400 to-orange-500',
      valueColor: summary.win_rate_pct >= 50 ? 'text-emerald-600 dark:text-emerald-300' : 'text-amber-600 dark:text-amber-300',
    ...
    },
    {
      ...
      badgeColor: summary.profit_factor >= 1.5 ? 'bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border-emerald-500/20' : 'bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 border-slate-200 dark:border-white/10',
      icon: Scale,
      accent: 'from-blue-400 to-indigo-500',
      valueColor: summary.profit_factor >= 1.5 ? 'text-emerald-600 dark:text-emerald-400' : 'text-slate-800 dark:text-slate-200',
    },
    {
      title: 'Max Drawdown',
      value: `-${summary.max_drawdown_pct.toFixed(2)}%`,
      badge: 'Peak-to-Trough',
      badgeColor: summary.max_drawdown_pct < 8 ? 'bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border-emerald-500/20' : 'bg-rose-500/10 text-rose-600 dark:text-rose-400 border-rose-500/20',
      icon: AlertTriangle,
      accent: 'from-rose-400 to-pink-600',
      valueColor: summary.max_drawdown_pct < 8 ? 'text-emerald-600 dark:text-emerald-400' : 'text-rose-600 dark:text-rose-400',
    },
    {
      title: 'Sharpe Ratio',
    ...
    },
    {
      ...
      badgeColor: 'bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border-slate-200 dark:border-white/10',
      icon: BarChart2,
          ...
          >
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="p-1.5 rounded-lg bg-slate-100 dark:bg-white/[0.04] border border-slate-200 dark:border-white/[0.08] text-slate-600 dark:text-slate-300 group-hover:text-cyan-600 dark:group-hover:text-cyan-400 transition-colors">
            ...
            <div className="mt-3 pt-2 border-t border-slate-200/60 dark:border-white/[0.06] flex items-center justify-between">
